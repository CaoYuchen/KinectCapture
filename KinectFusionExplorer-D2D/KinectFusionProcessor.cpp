...
Matrix4 mRot2Quat(const Matrix4& m);
...
HRESULT KinectFusionProcessor::GetKinectFrames(bool &colorSynchronized)
{
	...
	if (FIRST)
	{
		firstTimeStamp = currentDepthFrameTime;
		FIRST = false;
	}
	currentTimeStamp = currentDepthFrameTime - firstTimeStamp + 1000000000000;
...
bool KinectFusionProcessor::ProcessDepth()
{
    ...
    else
    {
		...
		// todo
		/*
		std::cout << m_worldToCameraTransform.M11 << " " << m_worldToCameraTransform.M12 << " " << m_worldToCameraTransform.M13 << " " << m_worldToCameraTransform.M14 << std::endl;
		std::cout << m_worldToCameraTransform.M21 << " " << m_worldToCameraTransform.M22 << " " << m_worldToCameraTransform.M23 << " " << m_worldToCameraTransform.M24 << std::endl;
		std::cout << m_worldToCameraTransform.M31 << " " << m_worldToCameraTransform.M32 << " " << m_worldToCameraTransform.M33 << " " << m_worldToCameraTransform.M34 << std::endl;
		std::cout << m_worldToCameraTransform.M41 << " " << m_worldToCameraTransform.M42 << " " << m_worldToCameraTransform.M43 << " " << m_worldToCameraTransform.M44 << std::endl;
		*/
		

		std::ofstream outfile;
		outfile.open("pose.txt", std::ios::binary | std::ios::app | std::ios::in | std::ios::out);
		Matrix4 quaternion = mRot2Quat(m_worldToCameraTransform);

		//outfile << FrameCounter << " ";
		outfile << m_cFrameCounter << " ";

		outfile << m_worldToCameraTransform.M41 << " " << m_worldToCameraTransform.M42 << " " << m_worldToCameraTransform.M43 << " ";
		outfile << quaternion.M11 << " " << quaternion.M12 << " " << quaternion.M13 << " " << quaternion.M14 << " \r\n";
		/*
		outfile << m_worldToCameraTransform.M41 << " " << m_worldToCameraTransform.M42 << " " << m_worldToCameraTransform.M43 << " " << m_worldToCameraTransform.M14 << " \r\n";
		outfile << m_worldToCameraTransform.M21 << " " << m_worldToCameraTransform.M22 << " " << m_worldToCameraTransform.M23 << " " << m_worldToCameraTransform.M24 << " \r\n";
		outfile << m_worldToCameraTransform.M31 << " " << m_worldToCameraTransform.M32 << " " << m_worldToCameraTransform.M33 << " " << m_worldToCameraTransform.M34 << " \r\n";
		outfile << m_worldToCameraTransform.M41 << " " << m_worldToCameraTransform.M42 << " " << m_worldToCameraTransform.M43 << " " << m_worldToCameraTransform.M44 << " \r\n\r\n";
		*/
...
HRESULT KinectFusionProcessor::FindCameraPoseAlignPointClouds()
{
    ...
    for (unsigned int n = 0; n < maxTests; n++)
    {
		...
		//Possibly, here poseProposal is going to be reflecting the current pose?
    ...
    if (bestNeighborIndex > -1)
    {
		...
		//Todo m_worldToCameraTransform might be what we are looking for!
